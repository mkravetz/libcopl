...
int main(int argc, char *argv[])
{
...
#ifdef REGX_SUPPORT
	char input_text[] =
	    "anchored_pattern unanchored_pat cASe_INSENs_pat prefixghisuffix \
        char_Class15 negated_bbc quatiiifie card wild fgdf card \ndouble.hash1 \
        \ndouble_hash2 \ndouble0hash3 \ndouble hash4 \ndoubleAhash5 \ndouble hash6! \
        anchored---wild_card anchored---wild_card anchored---wild_cardanchored---wild_card \n!double?hash1";
	...
	cop_regx_search_ex(s, 901, 902, src, src_size, 0, src_size-1, 0, src_size - 1);
